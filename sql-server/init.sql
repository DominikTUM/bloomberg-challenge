...
CREATE TABLE IF NOT EXISTS `test_db`.`Matches` ( `MatchID` INT NOT NULL AUTO_INCREMENT , `Security` TINYTEXT NOT NULL , `Seller` INT NOT NULL , `SellerOrderID` INT NOT NULL , `Buyer` INT NOT NULL , `BuyerOrderID` INT NOT NULL , `Qty` INT NOT NULL , `Price` DECIMAL NOT NULL , PRIMARY KEY (`MatchID`) ) ENGINE = InnoDB;
INSERT INTO `Exchange` (`ExchangeID`, `Security`, `UserID`, `Price`, `Qty`, `Side`) VALUES (NULL, 'Twitter', '1', '100', '10', 'buy'); 
INSERT INTO `Matches` (`MatchID`, `Security`, `Seller`, `SellerOrderID`, `Buyer`, `BuyerOrderID`, `Qty`, `Price`) VALUES (NULL, 'Twitter', '1', '2', '1', '2', '10', '90'); 
