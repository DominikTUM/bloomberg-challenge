...
CREATE TABLE IF NOT EXISTS `test_db`.`User` ( `UserID` INT NOT NULL AUTO_INCREMENT , `Email` TINYTEXT NOT NULL , `Role` TINYTEXT NOT NULL , `Name` TINYTEXT NOT NULL , `Password` TINYTEXT NOT NULL , PRIMARY KEY (`UserID`) ) ENGINE = InnoDB;

INSERT INTO `Exchange` (`ExchangeID`, `Security`, `UserID`, `Price`, `Qty`) VALUES (NULL, 'Twitter', '1', '100', '10'); 
INSERT INTO `Match` (`MatchID`, `Security`, `SellerId`, `BuyerId`, `Qty`, `Price`) VALUES (NULL, 'Twitter', '1', '2', '10', '90'); 
...
INSERT INTO `User` (`UserID`, `Email`, `Name`, `Password`, `Role`) VALUES (0, 'root@secex.com', 'Root', 'd0508cb8ac4296ebff9aafb902978f0ef167b6c03aa332bef035b521aabe6a18', 'admin');  
